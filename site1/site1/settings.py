...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', #attaching Whitenoise middleware
...
# Emplacement où seront stockés les fichiers statiques après la commande collectstatic
